...
namespace OgrenciYonetimSistemiV5
{
    class Uygulama
    {
        ...
        {
            Ogrenci o1 = new Ogrenci(1, "Aleyna", "Yesim", DateTime.Parse("4.5.2010"), CINSIYET.Kız, SUBE.B);
            Ogrenci o2 = new Ogrenci(2, "Hasan", "Berk", DateTime.Parse("3.11.1995"), CINSIYET.Kız, SUBE.A);
            Ogrenci o3 = new Ogrenci(3, "Selim", "Yavuz", DateTime.Parse("27.8.1985"), CINSIYET.Kız, SUBE.B);
            Ogrenci o4 = new Ogrenci(9, "Ali", "Kesici", DateTime.Parse("1.1.1993"), CINSIYET.Erkek, SUBE.C);
            ...
            o1.NotEkle(DERS.Fen, 11);
            o1.NotEkle(DERS.Matematik, 42);
            o1.NotEkle(DERS.Sosyal, 62);
            o1.NotEkle(DERS.Turkce, 67);

            o2.NotEkle(DERS.Fen, 78);
            o2.NotEkle(DERS.Matematik, 98);
            o2.NotEkle(DERS.Sosyal, 66);
            o2.NotEkle(DERS.Turkce, 56);

            o3.NotEkle(DERS.Fen, 23);
            o3.NotEkle(DERS.Matematik, 54);
            o3.NotEkle(DERS.Sosyal, 74);
            o3.NotEkle(DERS.Turkce, 12);

            o4.NotEkle(DERS.Fen, 15);
            o4.NotEkle(DERS.Matematik, 34);
            o4.NotEkle(DERS.Sosyal, 42);
            o4.NotEkle(DERS.Turkce, 96);

            o1.Adres.Sehir = "Denizli";
            o1.Adres.Semt = "Merkezefendi";
            o2.Adres.Sehir = "Istanbul";
            o2.Adres.Semt = "Basaksehir";
            o3.Adres.Sehir = "Afyon";
            o3.Adres.Semt = "Kocatepe";
            o4.Adres.Sehir = "Anyalya";
            o4.Adres.Semt = "Kas";

            o1.Kitaplar.Add("Gecenin karanlığı");
            o1.Kitaplar.Add("Sefiller");
            o2.Kitaplar.Add("Savas ve Baris");
            o2.Kitaplar.Add("Gelecegin Fizigi");
            o2.Kitaplar.Add("Bir Umuttur Yasamak");
            o3.Kitaplar.Add("Bir Omur Nasil Yasanir");
            o3.Kitaplar.Add("Suc ve Ceza");
            o4.Kitaplar.Add("Deniz Feneri");
